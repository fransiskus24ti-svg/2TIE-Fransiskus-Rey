...
// 1. Membuat TokoContext langsung di sini agar bisa dipakai halaman lain
export const TokoContext = createContext();

function App() {
  // 2. State Global untuk Data Inventaris
  ...
  // 3. State Global untuk Riwayat Transaksi
  ...
  // 4. State Global untuk Catatan Operasional
  ...
  return (
    <ThemeCustomization>
      {/* 5. Bungkus dengan Provider agar datanya bisa diakses di folder views */}
